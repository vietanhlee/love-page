...
export const config = {
  ...
  hero: {
    ...
    subtitle: "Mỗi kỷ niệm chúng mình có cùng nhau là một trang sách mà anh sẽ giữ mãi trong lòng.",
  ...
  sections: [
    {
      image: "https://images.unsplash.com/photo-1518199266791-5375a83df4d8?w=700&q=80",
    ...
    {
      image: "https://images.unsplash.com/photo-1522673607200-164d1b6d8e98?w=700&q=80",
      date: "Khi yêu nhau...",
      message:
